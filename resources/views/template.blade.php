...
<head>
    <title>Nailah Qonitah Firdausa : 5026231106</title>
    <meta charset="utf-8">
...
<body>
    <div class="jumbotron text-center mx-auto">
        <h1>5026231106 : Nailah Qonitah Firdausa</h1>
    </div>
    ...
    <nav class="navbar navbar-expand-sm bg-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/mobil">Tugas CRUD</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/keranjang">Latihan 3</a>
            </li>
        </ul>
    </nav>
    <br>
